    ...
    <div>
      <div className="flex  justify-between items-center h-[60px] max-w-5xl mx-auto">
        ...
        <div className="flex flex-row justify-center items-center text-slate-100 space-x-6">
          <NavLink to="/">
            <div>
              <p className=" border border-gray-600 rounded-md shadow-2xl p-1">Home</p>
            </div>
          </NavLink>
          <NavLink to="/login">
            <div>
                <p className=" border border-gray-600 rounded-md shadow-2xl p-1">Log In</p>
            </div>
          </NavLink>
          <NavLink to="/signup">
            <div>
                <p className=" border border-gray-600 rounded-md  shadow-2xl p-1">Sign Up</p>
            </div>
          </NavLink>
          <NavLink to="/cart">
